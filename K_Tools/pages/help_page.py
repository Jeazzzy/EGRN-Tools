...
TOOLS = [
    ...
    },
    {
        ...
        "summary": "Извлекает площадь объекта из всех PDF-файлов выпускных материалов.",
        "input": "Папка всего выпуска с вложенной папкой pdf, сама папка pdf или папка отдельного населённого пункта.",
        "workflow": "Программа рекурсивно находит PDF и ищет строку «Площадь объекта ± величина погрешности определения площади (P ± ΔP), м²». Документы без текстового слоя и неоднозначные значения отмечаются отдельно.",
        "result": "Таблица «населённый пункт — PDF-файл — площадь — статус». Площадь выводится без величины погрешности.",
    },
]
